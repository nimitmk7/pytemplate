...
class TestE2EWithPrebuiltRepo:
    ...
    def test_e2e_coverage_decrease(self, test_repo_copy: Path) -> None:
        ...
        with patch.object(git_client, 'get_pr_info', return_value=pr_info):
            ...
            with patch('pr_coverage_tool.pr_coverage_tool.subprocess') as \
                    mock_subprocess:
                ...
                modified_lines = report.coverage_delta.modified_lines[
                    "myproject/palindrome.py"
                ]
    ...
    def test_e2e_coverage_improvement(self, test_repo_copy: Path) -> None:
            ...
            with patch('pr_coverage_tool.pr_coverage_tool.subprocess') as \
                ...
                if "myproject/palindrome.py" in report.coverage_delta.modified_lines:
                    ...
                    newly_covered = [
                        ...
                        if line.before_status == "uncovered" and
                           line.after_status == "covered"
                    ]
                    # Could have some newly covered lines from better tests
                    assert len(newly_covered) >= 0

    def test_e2e_report_generation(self, test_repo_copy: Path) -> None:
